...
import { ScanLine, ImageIcon, Monitor, Smartphone, Cloud, Puzzle } from 'lucide-react';
...
// Hardware card
function HardwareCard({ name, tagline, specs, delay }: { name: string; tagline: string; specs: string[]; delay: number }) {
  return (
    <motion.div
...
export default function SpatialProducts() {
  ...
  const hw = hwKeys.map((k) => ({
    ...
    specs:   ['spec0','spec1','spec2','spec3','spec4']
               .map((s) => {
