...
import { Plane, Trophy, Landmark, Shield, Factory, Ship, type LucideIcon } from 'lucide-react';
import SectionTitle from '@/components/ui/SectionTitle';

const EASE = [0.25, 0.1, 0.25, 1] as const;
const ICONS: LucideIcon[] = [Plane, Trophy, Landmark, Shield, Factory, Ship];

export default function AirspaceIndustries() {
  const t = useTranslations('airspaceIndustries');
  ...
  return (
    <section id="airspace-industries" className="bg-background-alt py-24">
